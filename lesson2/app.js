...
app.get('/users',({query},res)=>{
    ...
    if (Object.keys(query).length){
        ...
        let usersAgeCityFilter = [...users];
        if (query.city){
            usersAgeCityFilter = usersAgeCityFilter.filter(users => user.city === query.city);
        }
        else if(query.age){
            usersAgeCityFilter = usersAgeCityFilter.filter(users => user.age === query.age)
        }

        res.render('users',{users:usersAgeCityFilter})
        return;
    }
